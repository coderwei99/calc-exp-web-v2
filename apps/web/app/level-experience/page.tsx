      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <Card className="shadow-lg">
          <CardHeader className="pb-4">
            ...
            <CardDescription>
              升级下一等级所需经验，以及累积经验总和。本表格数据来源于官方文档。
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-gray-500 dark:text-gray-400">
                数据来源: <a href="https://docs.qq.com/sheet/DR1FCbG5uU3RIZGxm?tab=BB08J2" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">官方文档</a>
              </span>
            </div>
                    ...
                    {levelData.map((data) => (
                      <TableRow 
                        ...
                        className={cn(
                          ...
                          highlightedLevel === data.level && "border-2 border-orange-400 dark:border-orange-500 bg-orange-50 dark:bg-orange-950/30"
                        )}
                      >
                        <TableCell className="text-center font-medium">
                          Lv{data.level}
                          {data.level < 165 && (
                            <span className="text-gray-400 text-sm ml-1">→ Lv{data.level + 1}</span>
                          )}
                        </TableCell>
